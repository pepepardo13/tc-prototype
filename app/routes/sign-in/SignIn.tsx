...
import envatoLogoSrc from "../sign-up/assets/envato-logo.svg";
import envatoMarkSrc from "../sign-up/assets/envato-mark.svg";
  ...
  return (
    <div className={styles.page}>
      ...
      <div className={styles.content}>
        <h1 className={styles.heroText}>Great to have you back!</h1>

        <div className={styles.card}>
          <h2 className={styles.cardHeading}>Sign In</h2>

          {/* Social buttons */}
          <div className={styles.socialButtons}>
            <button type="button" className={styles.socialButton} onClick={onSignIn}>
          ...
          <div className={styles.formFields}>
            <div className={styles.fieldGroup}>
              <div className={styles.fieldLabelRow}>
                <label className={styles.fieldLabel} htmlFor="signInEmail">
                  Username or Email
                </label>
                <button type="button" className={styles.fieldAction}>
                  Remind me
                </button>
              </div>
              <input
            ...
            <div className={styles.fieldGroup}>
              <div className={styles.fieldLabelRow}>
                <label className={styles.fieldLabel} htmlFor="signInPassword">
                  Password
                </label>
                <button type="button" className={styles.fieldAction}>
                  Forgot
          ...
          <div className={styles.cardFooter}>
            ...
            <p className={styles.legalText}>
              ...
              <a href="https://www.envato.com/privacy/">Privacy Policy</a>. By
              creating an account, you agree to our{" "}
              <a href="https://help.elements.envato.com/hc/en-us/articles/360000629006">
                User Terms
              </a>
              ; including our{" "}
              <a href="https://www.envato.com/fair-use/">Fair Use Policy.</a>
            </p>
          </div>
        </div>
      </div>
